...
make GRAPHENEDIR=/graphene THIS_DIR=/ppml/trusted-big-data-ml SPARK_LOCAL_IP=$local_ip SPARK_USER=root G_SGX_SIZE=$sgx_mem_size && \
cd /opt/jdk8/bin && \
ln -s /ppml/trusted-big-data-ml/java.sig java.sig && \
ln -s /ppml/trusted-big-data-ml/java.manifest java.manifest
